...
<section class="sheet">
    <div class="title-background">
        <h1 class="text-center title">見積書</h1>
    </div>
    <div class="issuing-date">
        <div class="flex-container-end">
            <div class="flex-item">発行日：</div>
            <div class="flex-item">{{$issuing_date}}</div>
        </div>
    </div>
    <div>
        <div class="client">
    ...
    <div class="flex-container">
        <div class="flex-item base">
            <div class="delivery-date">
                <div class="flex-container">
                    <div class="base-title flex-item">見積有効期限：</div>
                    <div style="flex-grow: 1;" class="flex-item text-center">{{$quote_expiration_date}}</div>
                </div>
            </div>
            <div class="total">
                <div class="flex-container">
                    <div class="base-title flex-item">税込合計金額：</div>
                    <div style="flex-grow: 1;" class="flex-item text-center total-price">￥{{ number_format($sum) }}
                    </div>
                </div>
            </div>
        </div>
